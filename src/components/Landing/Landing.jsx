...
const Landing = () => {
  ...
  <div className="container mx-auto px-6 relative z-10 text-center">
    <h1 className="text-7xl md:text-9xl font-black tracking-tighter mb-8 animate-shine">
      ...
      <div id="roles-section" className="py-24 px-8 max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 w-full max-w-6xl mb-32">
          ...
          <div className="group relative transition-all duration-500 hover:-translate-y-4">
            ...
            <div className="relative bg-[#2e3440] rounded-[1.8rem] p-12 border border-white/10 shadow-2xl flex flex-col items-center text-center h-full overflow-hidden">
              <div className="w-20 h-20 bg-[#88c0d0]/10 text-[#88c0d0] rounded-2xl flex items-center justify-center mb-8 transition-all duration-700 group-hover:rotate-360deg group-hover:bg-[#88c0d0] group-hover:text-[#2e3440]">
          ...
          <div className="group relative transition-all duration-500 hover:-translate-y-4">
            ...
            <div className="relative bg-[#2e3440] rounded-[1.8rem] p-12 border border-white/10 shadow-2xl flex flex-col items-center text-center h-full overflow-hidden">
              <div className="w-20 h-20 bg-[#b48ead]/10 text-[#b48ead] rounded-2xl flex items-center justify-center mb-8 transition-all duration-700 group-hover:rotate-360deg group-hover:bg-[#b48ead] group-hover:text-[#2e3440]">
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="text-4xl font-black text-white uppercase tracking-tighter mb-2 transition-colors group-hover:text-[#b48ead]">Student</h3>
              <p className="text-xs font-black text-[#b48ead] tracking-[0.3em] uppercase mb-6 opacity-80">Operational Suite</p>
              <p className="text-[#d8dee9]/70 font-medium leading-relaxed mb-10 grow">
          ...
          <div className="relative group overflow-hidden bg-[#2e3440] border border-white/10 rounded-[2.5rem] shadow-2xl transition-all duration-500">
            ...
            <div className="p-12 md:p-16 text-center relative z-10">
              <div className="inline-block px-6 py-2 rounded-full bg-[#88c0d0]/10 border border-[#88c0d0]/20 mb-12">
                <h3 className="text-xs font-black text-[#88c0d0] tracking-[0.4em] uppercase">Instructor Core Features</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                {[
                  ...
                  <div key={idx} className="group/item flex flex-col items-center p-6 rounded-2xl hover:bg-white/5 transition-all">
                    <div className="w-16 h-16 bg-[#88c0d0]/10 text-[#88c0d0] rounded-2xl flex items-center justify-center mb-6 group-hover/item:bg-[#88c0d0] group-hover/item:text-[#2e3440] transition-all">
                    ...
                    <p className="text-sm text-[#d8dee9]/60 leading-relaxed">{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="relative group overflow-hidden bg-[#2e3440] border border-white/10 rounded-[2.5rem] shadow-2xl transition-all duration-500">
            ...
            <div className="p-12 md:p-16 text-center relative z-10">
              <div className="inline-block px-6 py-2 rounded-full bg-[#b48ead]/10 border border-[#b48ead]/20 mb-12">
                <h3 className="text-xs font-black text-[#b48ead] tracking-[0.4em] uppercase">Student Workspace Features</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                {[
                  ...
                  <div key={idx} className="group/item flex flex-col items-center p-6 rounded-2xl hover:bg-white/5 transition-all">
                    <div className="w-16 h-16 bg-[#b48ead]/10 text-[#b48ead] rounded-2xl flex items-center justify-center mb-6 group-hover/item:bg-[#b48ead] group-hover/item:text-[#2e3440] transition-all">
                      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={item.icon} /></svg>
                    </div>
                    <h4 className="font-bold text-white text-lg mb-3">{item.title}</h4>
                    <p className="text-sm text-[#d8dee9]/60 leading-relaxed">{item.desc}</p>
